...
syms f d1 d2 width height u1 v1 u2 v2 r11 r12 r13 r21 r22 r23 r31 r32 r33 t1 t2 t3
...
slv_u2 = simplify(slv_u2,'Steps',1000);
% slv_u2 = collect(slv_u2,[u1,slope1]);
...
% slv_v2 = simplify(slv_v2,'Steps',1000);
% slv_v2 = subs(slv_v2,v1,u1*slope1+vh);
% slv_v2 = simplify(slv_v2,'Steps',1000);
% slv_v2 = collect(slv_v2,u1);
% % slv_v2 = simplify(slv_v2,'Steps',1000);
% pretty(slv_v2);

% expr = mlt(1)/mlt(2) == a(1)/a(2);
% expr = subs(expr,v1,u1*slope1+vh);
% expr = subs(expr,v2,u2*slope2+vh);
% 
% slv = solve(expr,slope2);
...
% slv=slv_v2/slv_u2;
% slv= simplify(slv,'Steps',10000);
% slv= collect(slv,slope1);
% pretty(slv);
